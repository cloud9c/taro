...
The full code is available below and as an editable [live example](https://jsfiddle.net/79n3pteb/). Play around with it to get a better understanding of how it works.
```html
<!DOCTYPE html>
<html>
  <head>
