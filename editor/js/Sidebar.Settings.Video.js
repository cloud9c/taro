...
function SidebarSettingsVideo( editor ) {
	...
	container.add( new UIText( strings.getKey( 'sidebar/setting/video' ) ).setTextTransform( 'uppercase' ) );
	...
	resolutionRow.add( new UIText( strings.getKey( 'sidebar/setting/resolution' ) ).setWidth( '90px' ) );
	...
	videoDurationRow.add( new UIText( strings.getKey( 'sidebar/setting/duration' ) ).setWidth( '90px' ) );
	...
	const renderButton = new UIButton( strings.getKey( 'sidebar/setting/render' ) ).setTextTransform( 'uppercase' );
