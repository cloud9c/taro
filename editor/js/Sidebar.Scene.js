...
import { UIOutliner, UITexture } from './libs/ui.taro.js';
	...
	function refreshUI() {
		...
		if ( scene.background ) {
			...
			if ( scene.background.isColor ) {
				...
				if ( scene.background.mapping === TARO.EquirectangularReflectionMapping ) {
		...
		if ( scene.environment ) {
			...
			if ( scene.environment.mapping === TARO.EquirectangularReflectionMapping ) {
