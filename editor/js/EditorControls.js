...
function EditorControls( object, domElement ) {
	...
	var scope = this;
	var vector = new TARO.Vector3();
	var delta = new TARO.Vector3();
	var box = new TARO.Box3();

	var STATE = { NONE: - 1, ROTATE: 0, ZOOM: 1, PAN: 2 };
	var state = STATE.NONE;

	var center = this.center;
	var normalMatrix = new TARO.Matrix3();
	var pointer = new TARO.Vector2();
	var pointerOld = new TARO.Vector2();
	var spherical = new TARO.Spherical();
	var sphere = new TARO.Sphere();
	...
	var touches = [ new TARO.Vector3(), new TARO.Vector3(), new TARO.Vector3() ];
	var prevTouches = [ new TARO.Vector3(), new TARO.Vector3(), new TARO.Vector3() ];
...
EditorControls.prototype = Object.create( TARO.EventDispatcher.prototype );
