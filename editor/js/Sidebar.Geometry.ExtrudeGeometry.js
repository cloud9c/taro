...
function GeometryParametersPanel( editor, object ) {
	...
	function update() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new TARO.ExtrudeGeometry(
			parameters.shapes,
			{
	...
	function toShape() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new TARO.ShapeGeometry(
			parameters.shapes,
