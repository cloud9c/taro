...
import { UIPoints3 } from './libs/ui.taro.js';
...
function GeometryParametersPanel( editor, object ) {
	...
	function update() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new TARO.TubeGeometry(
			new TARO.CatmullRomCurve3( points.getValue(), closed.getValue(), curveType.getValue(), tension.getValue() ),
