...
var _DEFAULT_CAMERA = new TARO.PerspectiveCamera( 50, 1, 0.01, 1000 );
_DEFAULT_CAMERA.name = 'Camera';
_DEFAULT_CAMERA.position.set( 0, 5, 10 );
_DEFAULT_CAMERA.lookAt( new TARO.Vector3() );
...
function Editor() {
	...
	this.mixer = new TARO.AnimationMixer( this.scene );
...
Editor.prototype = {
	...
	addHelper: function () {
		...
		var geometry = new TARO.SphereGeometry( 2, 4, 2 );
		var material = new TARO.MeshBasicMaterial( { color: 0xff0000, visible: false } );
		...
		return function ( object, helper ) {
			...
			if ( helper === undefined ) {
				...
				if ( object.isCamera ) {
					...
					helper = new TARO.SpotLightHelper( object );
					...
					helper = new TARO.SkeletonHelper( object );
				...
				const picker = new TARO.Mesh( geometry, material );
				picker.name = 'picker';
